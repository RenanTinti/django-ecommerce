...
class Order(models.Model):
    ...
    # This decorator checks if there's a physical item (non-digital item) in cart. If it has, it will ask for shipping information (customer address). The scripts will perform a loop through cart items.
    @property
    def shipping(self):
        shipping = False
        orderitems = self.orderitem_set.all()
